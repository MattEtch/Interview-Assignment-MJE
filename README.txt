How to run:
	...
	The algorithms are located in the TextStats class in the main package. 
	The ExampleUse class can be ran as a Java application to demonstrate the
	calculations on Lorem Ipsum.
	The TextTests class is located in the Test package. 
...
Reasoning behind chosen implementation
	...
	- The example class was added to demonstrate the algorithm results easily. 